...
function Menu() {
  ...
  const handleLogout = async () => {
    setOpenSubmenu(null); // Close the submenu before logging out
    try {
      // Send request to API for logout
      await axios.post('http://localhost:5000/login/logout', {}, { headers: { 'x-access-token': localStorage.getItem('token') } });
    ...
    <div className="d-flex">
      <div className="sidebar p-3">
        ...
        <div className="list-group">
          ...
          {openSubmenu === 'menu2' && (
            <div className="submenu">
              ...
              <a href="/seller"><button className="submenu-item textonleft"><i className="bi bi-person-circle me-2"></i> ผู้จำหน่าย</button></a>
              <a href="/custumer"><button className="submenu-item textonleft"><i className="bi bi-person-lines-fill me-2"></i> ลูกค้า</button></a>
              ...
              <a href="/problem_type"><button className="submenu-item textonleft"><i className="bi bi-bug me-2"></i> ประเภทปัญหา</button></a>
        ...
        <div className="logout-container">
          ...
          >
            <i className="bi bi-box-arrow-left me-2"></i> ออกจากระบบ
          </button>
        </div>
      </div>
    </div>
