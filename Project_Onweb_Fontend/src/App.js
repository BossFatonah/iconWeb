...
import Seller from './components/mainData/2.2_seller/Seller';
...
import ProblemType from './components/mainData/2.9_problem_type/ProblemType';
  ...
  return (
    <div>
      ...
      <Routes>
        ...
        <Route path="/problem_type" element={<ProtectedRoute><ProblemType /></ProtectedRoute>} />
